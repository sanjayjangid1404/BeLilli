...
/// data : {"id":"2","category_id":"2","business_name":"Adventure Co.","description":"We offer exciting outdoor activities such as hiking, kayaking, and more!","image":"/uploads/outdooractivites.jpg","contact_first_name":"Jane","contact_last_name":"Doe","email":"jane@adventureco.com","password":"password","hash":"hash","address1":"456 Oak St","address2":"","town":"Somewhere","county":"Somecounty","postcode":"67890","lat":"44.5678","lng":"-88.8765","website":"http://www.adventureco.com","featured":"1","active_cms":"1","active_app":"1","created":"2023-02-27 12:00:00","updated":"2023-02-27 07:06:18","category_name":"Activities","offer_title":"Buy One Get One Free","offer_terms":"Buy any item and get another item of equal or lesser value for free.","distance":"1787.113586547191"}
...
class BusinessDetailsResponse {
  ...
  BusinessDetailsResponse.fromJson(dynamic json) {
    _error = json['error'];
  ...
  String? _message;
  Data? _data;
BusinessDetailsResponse copyWith({  bool? error,
  String? message,
  Data? data,
}) => BusinessDetailsResponse(  error: error ?? _error,
...
/// offer_terms : "Buy any item and get another item of equal or lesser value for free."
...
Data copyWith({  String? id,
  ...
  offerTerms: offerTerms ?? _offerTerms,
  ...
  String? get offerTerms => _offerTerms;
