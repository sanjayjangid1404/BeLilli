...
class _LoginView extends State<LoginView> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((sp) async {
      ...
      print("Token=>$token");
      print("Token=>${sp.getString(saveUserToken)!}");
                ...
                child: Column(
                  ...
                  children: [
                   ...
                   Center(child: Image.asset("images/logo2.png",height: AppUtil.fullHeight(context)*0.04,)),
                    ...
                    SizedBox(height: AppUtil.fullHeight(context)*0.01,),
                    Align(
                                  ...
                                  else
                                  {
                                    ...
                                    controller.loginCallAPI(requestModel).then((value) async {
                                      ...
                                      if(response.error==false && response.data!=null)
                                      {
                                        ...
                                        DateTime date1 = DateTime.parse(response.data!.endDate==null || response.data!.endDate ==""? DateTime.now().toString() :
